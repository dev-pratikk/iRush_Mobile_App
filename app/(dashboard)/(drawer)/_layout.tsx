...
const styles = StyleSheet.create({
  ...
  drawerScrollViewContent: { flexGrow: 1, paddingTop: 0, paddingLeft: 0, paddingRight: 0 },
  drawerHeader: { padding: Spacing.lg, paddingTop: 20, flexDirection: 'row', alignItems: 'center', gap: 12 },
  drawerLogo: { width: 36, height: 36 },
  drawerTitle: { fontFamily: Typography.headingSemiBold, fontSize: 18 },
  divider: { height: 1, backgroundColor: '#E5E7EB', marginHorizontal: Spacing.lg },
  drawerItemsContainer: { marginTop: Spacing.md, paddingHorizontal: 0 },
  menuItemContainer: { position: 'relative' },
  menuItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: Spacing.lg, borderRadius: 10, marginHorizontal: 8 },
  menuLabel: { fontFamily: Typography.bodyMedium, fontSize: 15, marginLeft: 14 },
  activeIndicator: { position: 'absolute', right: 0, top: '50%', transform: [{ translateY: -12 }], width: 4, height: 24, borderRadius: 2 },
  spacer: { flex: 1 },
  versionContainer: { paddingVertical: Spacing.md, paddingHorizontal: Spacing.lg, alignItems: 'center' },
  versionText: { fontFamily: Typography.bodyMedium, fontSize: 13 },
  logoutContainer: { marginTop: Spacing.xs },
  logoutLabel: { fontFamily: Typography.bodyMedium },
});
